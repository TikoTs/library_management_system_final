...
class Author(models.Model):
    name = models.CharField(max_length=100, null=False, blank=False, verbose_name=_('Author Name'), unique=True,
...
class Genre(models.Model):
    name = models.CharField(max_length=100, null=False, blank=False, verbose_name=_('Genre Name'), unique=True,
...
class Book(models.Model):
    ...
    publish_date = models.DateField(verbose_name=_('Date of Publish'), default=timezone.now)
    stock_quantity = models.PositiveIntegerField(verbose_name=_('Quantity of Stock'), default=0)
...
class BookReservation(models.Model):
    ...
    borrower = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="reservations", verbose_name=_('Borrower'),
    ...
    reservation_status = models.CharField(max_length=50, choices=[('reserved', 'Reserved'), ('picked_up', 'Picked Up')],
                                          default='reserved', verbose_name=_('Reservation Status'))
...
class BooksBorrow(models.Model):
    ...
    borrower = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="borrows", verbose_name=_('Borrower'),
                                 on_delete=models.CASCADE)
    borrowed_date = models.DateTimeField(auto_now_add=True, verbose_name=_('Borrowed Date'),
                                         help_text=_('Creates automatically'))
    borrowed_status = models.CharField(max_length=50, choices=[('borrowed', 'Borrowed'), ('returned', 'Returned')],
                                       default='borrowed', verbose_name=_('Borrowed Status'))
